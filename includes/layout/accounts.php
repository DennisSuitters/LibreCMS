		...
		$r=$q->fetch(PDO::FETCH_ASSOC);?>
			...
			<div class="form-group">
				...
				<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
					...
					<div id="usernamesave" class="input-group-btn hidden">
			...
			<div class="form-group">
				...
				<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
					...
					<div id="passwordsave" class="input-group-btn hidden">
						<button class="btn btn-danger">Save</button>
					</div>
				</div>
			</div>
...
<?php	}?>
			<div class="well">
				...
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="gravatarsave" class="input-group-btn hidden">
							<button class="btn btn-danger">Save</button>
						</div>
					</div>
				</div>
			...
			<div class="form-group">
				...
				<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
					...
					<div id="namesave" class="input-group-btn hidden">
						<button class="btn btn-danger">Save</button>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
					...
					<div id="urlsave" class="input-group-btn hidden">
						<button class="btn btn-danger">Save</button>
					</div>
				</div>
			</div>
		...
		while($rs=$ss->fetch(PDO::FETCH_ASSOC)){?>
					<div id="l_<?php echo$rs['id'];?>" class="form-group">
						...
						<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
							...
							<div class="input-group-addon"><i class="fa fa-'.$rs['icon'].'"></i></div>
							<div class="input-group-addon">URL</div>
