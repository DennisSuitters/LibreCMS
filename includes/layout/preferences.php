					...
					<div class="well">
						...
						<div class="form-group">
							...
							<div class="input-group col-lg-10 col-md-10 col-sm-10 col-xs-8">
								...
								<div id="seoTitle<?php echo$r['id'];?>save" class="input-group-btn hidden">
						...
						<div class="form-group">
							...
							<div class="input-group col-lg-10 col-md-10 col-sm-10 col-xs-8">
								...
								<div id="seoCaption<?php echo$r['id'];?>save" class="input-group-btn hidden">
									<button class="btn btn-danger"><i class="fa fa-save"></i></button>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="input-group col-lg-10 col-md-10 col-sm-10 col-xs-8">
								...
								<div id="seoDescription<?php echo$r['id'];?>save" class="input-group-btn hidden">
									<button class="btn btn-danger"><i class="fa fa-save"></i></button>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="input-group col-lg-10 col-md-10 col-sm-10 col-xs-8">
								...
								<div id="seoKeywords<?php echo$r['id'];?>save" class="input-group-btn hidden">
									<button class="btn btn-danger"><i class="fa fa-save"></i></button>
								</div>
							</div>
						</div>
			...
			<div id="contact" class="tab-pane fade in">
				...
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="businesssave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="abnsave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="emailsave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="phonesave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8"><input type="text" id="mobile" class="form-control textinput" value="<?php echo$config['mobile'];?>" data-dbid="1" data-dbt="config" data-dbc="mobile" placeholder="Enter a Mobile Number...">
					<div id="mobilesave" class="input-group-btn hidden">
						<button class="btn btn-danger"><i class="fa fa-save"></i></button></div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="addresssave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="suburbsave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="citysave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="statesave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="postcodesave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="countrysave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
...
<?php }?>
				...
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="dateFormatsave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
			...
			<div id="banking" class="tab-pane fade in">
				...
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="banksave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="bankAccountNamesave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="bankAccountNumbersave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="bank_bsbsave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group col-lg-11 col-md-10 col-sm-10 col-xs-8">
						...
						<div id="bankPayPalsave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group col-lg-10 col-md-9 col-sm-9 col-xs-7">
						...
						<div id="orderEmailDefaultSubjectsave" class="input-group-btn hidden">
							<button class="btn btn-danger"><i class="fa fa-save"></i></button>
						</div>
