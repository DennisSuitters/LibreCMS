		...
		$head.='<div id="seocontent">';
			$head.='<div class="libr8 panel-body">';
				$head.='<div class="libr8 form-group">';
					$head.='<label for="seoTitle" class="libr8 control-label col-lg-2 col-md-3 col-sm-3 col-xs-5">Page Title</label>';
					$head.='<div class="libr8 input-group col-lg-10 col-md-9 col-sm-9 col-xs-7">';
						...
						$head.='<div id="seoTitlesave" class="input-group-btn hidden">';
							$head.='<button class="libr8 btn btn-danger"><i class="fa fa-save"></i></button>';
						$head.='</div>';
					$head.='</div>';
				$head.='</div>';
				$head.='<div class="libr8 form-group">';
					$head.='<label for="seoCaption" class="libr8 control-label col-lg-2 col-md-3 col-sm-3 col-xs-5">Page Caption</label>';
					$head.='<div class="libr8 input-group col-lg-10 col-md-9 col-sm-9 col-xs-7">';
						...
						$head.='<div id="seoCaptionsave" class="libr8 input-group-btn hidden">';
							$head.='<button class="libr8 btn btn-danger"><i class="fa fa-save"></i></button>';
						$head.='</div>';
					$head.='</div>';
				$head.='</div>';
				$head.='<div class="libr8 form-group">';
					$head.='<label for="seoDescription" class="libr8 control-label col-lg-2 col-md-3 col-sm-3 col-xs-5">Page Description</label>';
					$head.='<div class="libr8 input-group col-lg-10 col-md-9 col-sm-9 col-xs-7">';
						...
						$head.='<div id="seoDescriptionsave" class="libr8 input-group-btn hidden">';
							$head.='<button class="libr8 btn btn-danger"><i class="fa fa-save"></i></button>';
						$head.='</div>';
					$head.='</div>';
				$head.='</div>';
				$head.='<div class="libr8 form-group">';
					$head.='<label for="seoKeywords" class="libr8 control-label col-lg-2 col-md-3 col-sm-3 col-xs-5">Page Keywords</label>';
					$head.='<div class="libr8 input-group col-lg-10 col-md-9 col-sm-9 col-xs-7">';
						...
						$head.='<div id="seoKeywordssave" class="libr8 input-group-btn hidden">';
							$head.='<button class="libr8 btn btn-danger"><i class="fa fa-save"></i></button>';
						$head.='</div>';
					$head.='</div>';
				$head.='</div>';
				$head.='<div class="libr8 form-group">';
					$head.='<label for="notes" class="libr8 control-label col-lg-2 col-md-3 col-sm-3 col-xs-5">Page Notes</label>';
					$head.='<div class="libr8 input-group col-lg-10 col-md-9 col-sm-9 col-xs-7">';
