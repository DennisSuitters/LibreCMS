...
! function(e, t) {
    ...
    var a, n, s, c, u, d, l, f, p, g, h, m, v, b, y, w, I, _, C, j, S, T, L, E, O, A, x, P, D, k, Q, q, U, N, G, R, K, H, M, V, z, B, X, J, Y = (n = "ajaxLoad", s = "coreui.ajaxLoad", c = (a = t).fn[n], u = "active", d = "open", l = "view-script", f = "click", p = ".sidebar-nav .nav-dropdown", g = ".sidebar-nav .nav-link", h = ".sidebar-nav .nav-item", m = ".view-script", v = {
            ...
            errorPage: "dashboard.php",
            subpagesDirectory: "layout/"
        }, b = function() {
            function n(e, t) {
        ...
        W = (O = "sidebar", A = "coreui.sidebar", x = (E = t).fn[O], P = "active", D = "brand-minimized", k = "open", Q = "sidebar-minimized", q = {
            ...
            TOGGLE: "toggle"
        }, U = "body", N = ".brand-minimizer", G = ".nav-dropdown-toggle", R = ".nav-dropdown-items", K = ".nav-link", H = ".sidebar-nav", M = ".sidebar-nav > .nav", V = ".sidebar", z = "", B = ".sidebar-toggler", X = ["sidebar-show", "sidebar-sm-show", "sidebar-md-show", "sidebar-lg-show", "sidebar-xl-show"], J = function() {
            function n(e) {
