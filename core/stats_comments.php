...
while($r=$s->fetch(PDO::FETCH_ASSOC)){
	...
	echo'<div class="panel-footer"><a href="'.URL.'/admin/content/edit/'.$rc['id'].'#comments"><span class="pull-left">'.$rc['title'].'</span><span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span></a><div class="clearfix"></div></div>';
}