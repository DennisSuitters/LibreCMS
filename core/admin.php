  ...
  <body class="<?php if(isset($_COOKIE['adminbg']))echo$_COOKIE['adminbg'];?>">
    <div id="sidemenu">
      <aside class="nav-side-menu">
        ...
        <div id="menu-list" class="menu-list<?php if(isset($_COOKIE['adminbg']))echo' '.$_COOKIE['adminbg'];?>">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="<?php echo URL.$settings['system']['admin'];?>/content"><span id="nav-nc"><?php echo$nc['cnt'];?></span> Comments<?php svg('comments');?></a></li>
              <li><a href="<?php echo URL.$settings['system']['admin'];?>/content"><span id="nav-nr"><?php echo$nr['cnt'];?></span> Reviews<?php svg('layout-timeline');?></a></li>
              <li><a href="<?php echo URL.$settings['system']['admin'];?>/messages"><span id="nav-nm"><?php echo$nm['cnt'];?></span> Messages<?php svg('envelope');?></a></li>
              <li><a href="<?php echo URL.$settings['system']['admin'];?>/orders/pending"><span id="nav-po"><?php echo$po['cnt'];?></span> Orders<?php svg('shopping-cart');?></a></li>
              <li><a href="<?php echo URL.$settings['system']['admin'];?>/bookings"><span id="nav-nb"><?php echo$nb['cnt'];?></span> Bookings<?php svg('calendar');?></a></li>
              <li><a href="<?php echo URL.$settings['system']['admin'];?>/accounts"><span id="nav-nu"><?php echo$nu['cnt'];?></span> Users<?php svg('users');?></a></li>
              <li><a href="<?php echo URL.$settings['system']['admin'];?>/content/type/testimonials"><span id="nav-nt"><?php echo$nt['cnt'];?></span> Testimonials<?php svg('signature');?></a></li>
              <li><a href="<?php echo URL.$settings['system']['admin'];?>/accounts"><span id="nav-nou"><?php echo$nou['cnt'];?></span> Active Users <?php svg('users');?></a></li>
            </ul>
          </li>
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
              <?php if($user['name']!='')echo$user['name'];else echo$user['username'];?> <span class="caret"></span>
