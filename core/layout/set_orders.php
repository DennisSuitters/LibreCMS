...
<div class="panel panel-default">
  <div class="panel-heading clearfix">
    ...
    <div class="btn-group pull-right">
      ...
      <?php if($help['orders_settings_text']!='')echo'<a target="_blank" class="btn btn-default info" href="'.$help['orders_settings_text'].'" data-toggle="tooltip" data-placement="left" title="Help">'.svg2('libre-gui-help').'</a>';if($help['orders_settings_video']!='')echo'<a href="#" class="btn btn-default info" data-toggle="modal" data-frame="iframe" data-target="#videoModal" data-video="'.$help['orders_settings_video'].'" data-tooltip="tooltip" data-placement="left" title="Watch Video Help">'.svg2('libre-gui-video').'</a>';?>
    </div>
  </div>
  <div class="panel-body">
    ...
    <div class="form-group">
      ...
      <div class="input-group col-xs-7 col-sm-9 col-lg-10">
        <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="bankAccountName">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
    ...
    <div class="form-group">
      ...
      <div class="input-group col-xs-7 col-sm-9 col-lg-10">
        <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="bankAccountNumber">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
    ...
    <div class="form-group">
      ...
      <div class="input-group col-xs-7 col-sm-9 col-lg-10">
        <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="bankBSB">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
    ...
    <div class="form-group">
      ...
      <div class="input-group col-xs-7 col-sm-9 col-lg-10">
        <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="bankPayPal">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
    ...
    <div class="form-group">
      ...
      <div class="input-group col-xs-7 col-sm-9 col-lg-10">
        <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="orderPayti">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
    ...
    <div class="form-group clearfix">
      ...
      <?php echo($user['rank']>899?'<div class="input-group-btn hidden-xs" style="background-color:#f5f5f5;border:1px solid #ccc;border-bottom:0;"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="oen">'.svg2('libre-gui-fingerprint').'</button></div><div id="oen" data-dbid="1" data-dbt="config" data-dbc="orderEmailNotes"></div>':'');?>
    ...
    <div class="form-group clearfix">
      ...
      <div class="input-group col-xs-7 col-sm-9 col-lg-10">
        <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="orderEmailSubject">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
    ...
    <div class="form-group clearfix">
      ...
      <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs" style="background-color:#f5f5f5;border:1px solid #ccc;border-bottom:0;"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="oel">'.svg2('libre-gui-fingerprint').'</button></div><div id="oel" data-dbid="1" data-dbt="config" data-dbc="orderEmailLayout"></div>':'';?>
      <div class="input-group col-xs-7 col-sm-9 col-lg-10 pull-right">
        <form method="post" target="sp" action="core/update.php">
          <input type="hidden" name="id" value="1">
          <input type="hidden" name="t" value="config">
