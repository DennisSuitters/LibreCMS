<div class="panel panel-default">
  <div class="panel-heading clearfix">
    ...
    <div class="pull-right">
      ...
      <div class="btn-group">
        <a target="_blank" class="btn btn-default info" href="https://github.com/StudioJunkyard/LibreCMS/wiki/Administration#orders-settings"<?php if($config['options']{4}==1)echo' data-toggle="tooltip" data-placement="left" title="Help"';?>><?php svg('help');?></a>
      </div>
    </div>
  </div>
...
<?php if($user['rank']>899){?>
        <div class="input-group-btn hidden-xs">
          <button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="bankAccountName"><?php svg('fingerprint');?></button>
        </div>
<?php }?>
...
<?php if($user['rank']>899){?>
        <div class="input-group-btn hidden-xs">
          <button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="bankAccountNumber"><?php svg('fingerprint');?></button>
        </div>
<?php }?>
...
<?php if($user['rank']>899){?>
        <div class="input-group-btn hidden-xs">
          <button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="bankBSB"><?php svg('fingerprint');?></button>
        </div>
<?php }?>
...
<?php if($user['rank']>899){?>
        <div class="input-group-btn hidden-xs">
          <button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="bankPayPal"><?php svg('fingerprint');?></button>
        </div>
<?php }?>
    ...
    <div class="form-group">
      ...
      <div class="input-group col-xs-7 col-sm-9 col-lg-10">
        <input type="text" id="ipn" class="form-control" value="Not Yet Implemented" readonly<?php if($config['options']{4}==1)echo' data-toggle="tooltip" title=""';?>>
      </div>
    </div>
...
<?php if($user['rank']>899){?>
        <div class="input-group-btn hidden-xs">
          <button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="orderPayti"><?php svg('fingerprint');?></button>
        </div>
<?php }?>
...
<?php if($user['rank']>899){?>
        <div class="input-group-btn hidden-xs">
          <button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="oen"><?php svg('fingerprint');?></button>
        </div>
        <div id="oen" data-dbid="1" data-dbt="config" data-dbc="orderEmailNotes"></div>
<?php }?>
...
<?php if($user['rank']>899){?>
        <div class="input-group-btn hidden-xs">
          <button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="orderEmailSubject"><?php svg('fingerprint');?></button>
        </div>
<?php }?>
...
<?php if($user['rank']>899){?>
        <div class="input-group-btn hidden-xs">
          <button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="oel"><?php svg('fingerprint');?></button>
        </div>
        <div id="oel" data-dbid="1" data-dbt="config" data-dbc="orderEmailLayout"></div>
<?php }?>
        <form method="post" target="sp" action="core/update.php">
          <input type="hidden" name="id" value="1">
          <input type="hidden" name="t" value="config">
