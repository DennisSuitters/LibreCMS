 ...
 *
 * Administration - SEO Stats for Pages
 *
 * seostats-pages.php version 2.0.0
 *
 ...
 *
 * @category   Administration - SEO Stats for Pages
 * @package    core/layout/seostats-pages.php
...
<script>/*<![CDATA[*/
  $.get("core/layout/seostats-google.php?id=<?php echo $id;?>&t=menu&u=<?php echo $u;?>", {}, function (results) {
...
<script>/*<![CDATA[*/
  $.get("core/layout/seostats-alexa.php?id=<?php echo $id;?>&t=menu&u=<?php echo $u;?>", {}, function (results) {
...
<script>/*<![CDATA[*/
  $.get("core/layout/seostats-moz.php?id=<?php echo $id;?>&t=menu&u=<?php echo $u;?>", {}, function (results) {
