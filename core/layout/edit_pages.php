          ...
          <div id="tab-page-content" class="tab-pane active" role="tabpanel">
            <div class="form-group row">
              ...
              <div class="input-group col-sm-10">
                ...
                if($r['suggestions']==1){$ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");$ss->execute(array(':rid'=>$r['id'],':t'=>'menu',':c'=>'title'));
                echo$ss->rowCount()>0?'<div class="input-group-prepend" data-tooltip="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-secondary suggestions" data-dbgid="title">'.svg2('libre-gui-lightbulb').'</button></div>':'';}?>
  ...
  $ss->execute(
    array(
      ...
      ':c'=>'notes'
                ...
                echo$ss->rowCount()>0?'<span data-tooltip="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-secondary btn-sm suggestions" data-dbgid="notesda">'.svg2('libre-gui-lightbulb').'</button></span>':'';
}
                echo$user['rank']>899?'<span class="float-right" data-tooltip="tooltip" data-placement="top" title="Add Suggestion"><button class="btn btn-secondary btn-sm addsuggestion" data-dbgid="notesda">'.svg2('libre-gui-idea').'</button></span>':'';?>
          ...
          <div id="tab-page-images" class="tab-pane" role="tabpanel">
            <fieldset class="control-fieldset">
              ...
              <div class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="coverURL">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                  ...
                  <div class="input-group-append"><button class="btn btn-secondary trash" onclick="coverUpdate('<?php echo$r['id'];?>','menu','coverURL','');"><?php svg('libre-gui-trash');?></button></div>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="cover">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                  ...
                  <div class="input-group-append">
                    <button class="btn btn-secondary" onclick="elfinderDialog('<?php echo$r['id'];?>','menu','cover');"><?php svg('libre-gui-browse-media');?></button>
                  </div>
                  <div class="input-group-append img">
<?php if($r['cover']!='')
                    echo'<a href="'.$r['cover'].'" data-featherlight="image"><img id="coverimage" src="'.$r['cover'].'"></a>';
elseif($r['coverURL']!='')
                    echo'<a href="'.$r['coverURL'].'" data-featherlight="image"><img id="coverimage" src="'.$r['coverURL'].'"></a>';
elseif($r['coverURL'] != '')
                    echo'<a href="'.$r['coverURL'].'" data-featherlight="image"><img id="coverimage" src="'.$r['coverURL'].'"></a>';
else
                    echo'<img id="coverimage" src="'.NOIMAGE.'">';?>
                  </div>
                  <div class="input-group-append">
                    <button class="btn btn-secondary trash" onclick="coverUpdate('<?php echo$r['id'];?>','menu','cover','');"><?php svg('libre-gui-trash');?></button>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="coverVideo">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                  ...
                  <div class="input-group-append">
                    <button class="btn btn-secondary" onclick="elfinderDialog('<?php echo$r['id'];?>','menu','coverVideo');"><?php svg('libre-gui-browse-media');?></button>
                  </div>
                  <div class="input-group-append">
                    <button class="btn btn-secondary trash" onclick="coverUpdate('<?php echo$r['id'];?>','menu','coverVideo','');"><?php svg('libre-gui-trash');?></button>
                  </div>
                </div>
              </div>
            </fieldset>
            ...
            <form target="sp" method="post" enctype="multipart/form-data" action="core/add_data.php">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <div class="input-group-append"><button class="btn btn-secondary" onclick="elfinderDialog('<?php echo$r['id'];?>','media','file');return false;"><?php svg('libre-gui-browse-media');?></button></div>
          ...
          <div id="tab-page-seo" class="tab-pane" role="tabpanel">
            <div class="form-group row">
              ...
              <div class="input-group col-sm-10">
                ...
                <div class="input-group-addon"><button class="btn btn-secondary trash" onclick="$('#views').val('0');update('<?php echo$r['id'];?>','menu','views','0');"><?php svg('libre-gui-eraser');?></button></div>
            ...
            <div class="form-group row">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-append"><button class="btn btn-secondary fingerprint" data-dbgid="metaRobots">'.svg2('libre-gui-fingerprint').'</button></div>':'';
if($r['suggestions']==1){
  $ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");
  $ss->execute(
    array(
      ...
      ':c'=>'metaRobots'
                ...
                echo$ss->rowCount()>0?'<div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-default suggestion" data-dbgid="metaRobots">'.svg2('libre-gui-lightbulb').'</button></div>':'';}?>
                ...
                <?php echo$user['rank']>899?'<div class="input-group-prepend" data-tooltip="tooltip" data-placement="top" title="Add Suggestion"><button class="btn btn-secondary addsuggestion" data-dbgid="metaRobots">'.svg2('libre-gui-idea').'</button></div>':'';?>
...
if($cntc<0){
  ...
  $cnt=number_format($cnt)*-1;
                ...
                <div class="input-group-prepend">
                  <button class="btn btn-secondary" onclick="removeStopWords('seoTitle',$('#seoTitle').val());" data-toggle="tooltip" title="Remove Stop Words."><?php svg('libre-gui-magic');?></button>
                </div>
  ...
  $ss->execute(
    array(
      ...
      ':c'=>'seoTitle'
                ...
                echo$ss->rowCount()>0?'<div class="input-group-prepend" data-tooltip="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-default suggestion" data-dbgid="seoTitle">'.svg2('libre-gui-lightbulb').'</button></div>':'';}?>
                ...
                <?php echo$user['rank']>899?'<div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Add Suggestion"><button class="btn btn-secondary addsuggestion" data-toggle="popover" data-dbgid="seoTitle">'.svg2('libre-gui-idea').'</button></div>':'';?>
  ...
  $ss->execute(
    array(
      ...
      ':c'=>'seoCaption'
                ...
                echo$ss->rowCount()>0?'<div class="input-group-prepend" data-tooltip="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-secondary suggestion" data-toggle="popover" data-dbgid="seoCaption">'.svg2('libre-gui-lightbulb').'</button></div>':'';
}?>
                ...
                <?php echo$user['rank']>899?'<div class="input-group-btn" data-toggle="tooltip" data-placement="top" title="Add Suggestion"><button class="btn btn-secondary addsuggestion hidden-xs" data-toggle="popover" data-dbgid="seoCaption">'.svg2('libre-gui-idea').'</button></div>':'';?>
  ...
  $ss->execute(
    array(
      ...
      ':c'=>'seoDescription'
                ...
                echo$ss->rowCount()>0?'<div class="input-group-prepend" data-tooltip="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-secondary suggestion" data-toggle="popover" data-dbgid="seoDescription">'.svg2('libre-gui-lightbulb').'</button></div>':'';
}?>
                ...
                <?php echo$user['rank']>899?'<div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Add Suggestion"><button class="btn btn-secondary addsuggestion" data-toggle="popover" data-dbgid="seoDescription">'.svg2('libre-gui-idea').'</button></div>':'';?>
  ...
  $ss->execute(
    array(
      ...
      ':c'=>'seoKewords'
                ...
                echo$ss->rowCount()>0?'<div class="input-group-prepend" data-tooltip="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-secondary suggestion" data-toggle="popover" data-dbgid="seoKeywords">'.svg2('libre-gui-lightbulb').'</button></div>':'';
}?>
                ...
                <?php echo$user['rank']>899?'<div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Add Suggestion"><button class="btn btn-secondary addsuggestion" data-toggle="popover" data-dbgid="seoKeywords">'.svg2('libre-gui-idea').'</button></div>':'';?>
...
<?php if($r['contentType']!='index'){?>
            ...
            <div class="form-group row">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="url">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
...
<?php }?>
            <div class="form-group row">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="menu">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
