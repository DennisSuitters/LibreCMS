...
<html lang="<?php echo$config['language'];?>" id="libreCMS">
  <head>
    ...
    echo$view=='bookings'||$args[0]=='scheduler'?'<script src="'.URL.'core'.DS.'js'.DS.'fullcalendar.min.js"></script><script src="'.URL.'core'.DS.'js'.DS.'fullcalendar'.DS.'locales'.DS.strtolower($config['language']).'"></script>':'';
