		...
		<div class="container col col-sm-6">
			...
			<div class="card mt-2 shadow">
				...
				<div class="card-body">
					<div id="dbinfo"></div>
<?php $error=0;
if(version_compare(phpversion(),'7.0','<'))echo'<div class="alert alert-warning">LibreCMS was built using PHP v7.0, your installed version is lower. While LibreCMS may operate on your system, some functionality may not work or be available. We recommend using PHP 7.3 if available on you\'re services.</div>';
...
<?php }
							...
							<div class="float-right">
								<button type="submit" class="btn btn-success btn-lg" onclick="$('#block').css({'display':'block'});">Next</button>
							</div>
						</form>
					</div>
					<div id="step3" class="d-none">
						<h4 class="card-title">Administrator Account Settings</h4>
						<form target="sp" method="post" action="core/installer.php">
							<input type="hidden" name="emailtrap" value="none">
