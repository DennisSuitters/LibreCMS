...
<main id="content" class="main">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><?php echo ucfirst($r['contentType']).(in_array($r['contentType'],array('article'))?'s':'');?></li>
    ...
    <li class="breadcrumb-menu">
      <div class="btn-group" role="group" aria-label="">
        ...
        <?php if($help['content_edit_text']!='')echo'<a target="_blank" class="btn btn-ghost-normal info" href="'.$help['content_edit_text'].'" data-toggle="tooltip" data-placement="left" title="Help" savefrom_lm="false">'.svg2('libre-gui-help').'</a>';
          ...
          <div id="tab-content-content" class="tab-pane active" role="tabpanel">
            ...
            <div id="nav-content-content-1" class="form-group row">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="title">'.svg2('libre-gui-fingerprint').'</button></div>':'';
if($r['suggestions']==1){$ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");$ss->execute(array(':rid'=>$r['id'],':t'=>'content',':c'=>'title'));
                echo$ss->rowCount()>0?'<div class="input-group-prepend" data-tooltip="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-default suggestion" data-toggle="popover" data-dbgid="title">'.svg2('libre-gui-lightbulb').'</button></div>':'';
}?>
                ...
                <?php echo$user['rank']>899?'<div class="input-group-btn" data-tooltip="tooltip" data-placement="top" title="Add Suggestion"><button class="btn btn-secondary addsuggestion" data-toggle="popover" data-dbgid="title">'.svg2('libre-gui-idea').'</button></div>':'';?>
            ...
            <div id="nav-content-content-3" class="form-group row<?php echo$r['contentType']=='proofs'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                ...
                <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="savepti" class="btn btn-secondary save" data-dbid="pti" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
              </div>
            </div>
            ...
            <div id="nav-content-content-5" class="form-group row<?php echo$r['contentType']=='article'||$r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='inventory'||$r['contentType']=='gallery'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="cid">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
...
<?php $cs=$db->query("SELECT * FROM `".$prefix."login` ORDER BY name ASC, username ASC");while($cr=$cs->fetch(PDO::FETCH_ASSOC))
            ...
            <div id="nav-content-content-6" class="form-group row<?php echo$r['contentType']=='portfolio'||$r['contentType']=='events'||$r['contentType']=='testimonials'||$r['contentType']=='inventory'||$r['contentType']=='service'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="uid">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
...
<?php $su=$db->query("SELECT id,username,name FROM `".$prefix."login` WHERE username!='' AND status!='delete' ORDER BY username ASC, name ASC");while($ru=$su->fetch(PDO::FETCH_ASSOC))
            ...
            <div id="nav-content-content-7" class="form-group row<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="code">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                ...
                <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="savecode" class="btn btn-secondary save" data-dbid="code" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
              </div>
            </div>
            <div id="nav-content-content-8" class="form-group row<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-toggle="popover" data-dbgid="barcode">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                ...
                <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="savebarcode" class="btn btn-secondary save" data-dbid="barcode" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
              </div>
            </div>
            ...
            <div id="nav-content-content-9" class="form-group row<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='service'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="fccid">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                ...
                <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="savefccid" class="btn btn-secondary save" data-dbid="fccid" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
              </div>
            </div>
            <div id="nav-content-content-10" class="form-group row<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='service'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="brand">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
...
<?php $s=$db->query("SELECT DISTINCT brand FROM `".$prefix."content` WHERE brand!='' ORDER BY brand ASC");while($rs=$s->fetch(PDO::FETCH_ASSOC))
                  echo'<option value="'.$rs['brand'].'"/>';?>
                </datalist>
                <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="savebrand" class="btn btn-secondary save" data-dbid="brand" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
              </div>
            </div>
            <div id="nav-content-content-11" class="form-group row<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='inventory'||$r['contentType']=='service'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="tis">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
            ...
            <div id="nav-content-content-12" class="form-group row<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='inventory'||$r['contentType']=='service'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="tie">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
            ...
            <div id="nav-content-content-13" class="form-group row<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='news'||$r['contentType']=='inventory'||$r['contentType']=='service'||$r['contentType']=='gallery'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="email">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
            ...
            <div id="nav-content-content-14" class="form-group row<?php echo$r['contentType']=='article'||$r['contentType']=='news'||$r['contentType']=='inventory'||$r['contentType']=='service'||$r['contentType']=='gallery'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="name">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
...
<?php $s=$db->query("SELECT DISTINCT name FROM `".$prefix."content` UNION SELECT DISTINCT name FROM `".$prefix."login` ORDER BY name ASC");while($rs=$s->fetch(PDO::FETCH_ASSOC))
            ...
            <div id="nav-content-content-15" class="form-group row<?php echo$r['contentType']=='article'||$r['contentType']=='news'||$r['contentType']=='inventory'||$r['contentType']=='service'||$r['contentType']=='gallery'?' hidden':'';?>">
              ...
              <div class="input-group col-xs-7 col-sm-9 col-lg-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-toggle="popover" data-dbgid="url">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
            ...
            <div id="nav-content-content-16" class="form-group row<?php echo$r['contentType']=='article'||$r['contentType']=='news'||$r['contentType']=='inventory'||$r['contentType']=='service'||$r['contentType']=='gallery'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-toggle="popover" data-dbgid="business">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
            ...
            <div id="nav-content-content-17" class="form-group row<?php echo$r['contentType']=='testimonials'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="category_1">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
...
<?php $s=$db->query("SELECT DISTINCT category_1 FROM `".$prefix."content` WHERE category_1!='' ORDER BY category_1 ASC");while($rs=$s->fetch(PDO::FETCH_ASSOC))
                  echo'<option value="'.$rs['category_1'].'"/>';?>
                </datalist>
                <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="savecategory_1" class="btn btn-secondary save" data-dbid="category_1" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
              </div>
            </div>
            <div id="nav-content-content-18" class="form-group row<?php echo$r['contentType']=='testimonials'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="category_2">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
...
<?php $s=$db->query("SELECT DISTINCT category_2 FROM `".$prefix."content` WHERE category_2!='' ORDER BY category_2 ASC");while($rs=$s->fetch(PDO::FETCH_ASSOC))
                  echo'<option value="'.$rs['category_2'].'"/>';?>
                </datalist>
                <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="savecategory_2" class="btn btn-secondary save" data-dbid="category_2" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
              </div>
            </div>
            <div id="nav-content-content-19" class="form-group row<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="cost">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                ...
                <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="savecost" class="btn btn-secondary save" data-dbid="cost" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
              </div>
            </div>
            ...
            <div id="nav-content-content-21" class="form-group row<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='service'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="quantity">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                ...
                <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="savequantity" class="btn btn-secondary save" data-dbid="quantity" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
              </div>
            </div>
            <div id="nav-content-content-22" class="form-group">
              <div class="card-header col-sm-12 position-relative" style="padding:0;">
                <?php echo$user['rank']>899?'<button class="btn btn-secondary btn-sm fingerprint" data-dbgid="notesda">'.svg2('libre-gui-fingerprint').'</button>':'';
if($r['suggestions']==1){
  ...
  $ss->execute(
    array(
      ...
      ':c'=>'notes'
                ...
                echo$ss->rowCount()>0?'<div data-tooltip="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-secondary suggestion" data-dbgid="notesda">'.svg2('libre-gui-lightbulb').'</button></div>':'';
}
                echo$user['rank']>899?'<div class="float-right" data-tooltip="tooltip" data-placement="top" title="Add Suggestion"><button class="btn btn-secondary btn-sm addsuggestion" data-dbgid="notesda">'.svg2('libre-gui-idea').'</button></div>':'';?>
            ...
            <fieldset id="nav-content-content-23" class="control-fieldset<?php echo$r['contentType']=='portfolio'||$r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='inventory'||$r['contentType']=='service'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?>">
              ...
              <div id="nav-content-content-24" class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="attributionContentName">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
...
<?php $s=$db->query("SELECT DISTINCT attributionContentName AS name FROM `".$prefix."content` UNION SELECT DISTINCT name FROM `".$prefix."content` UNION SELECT DISTINCT name FROM `".$prefix."login` ORDER BY name ASC");while($rs=$s->fetch(PDO::FETCH_ASSOC))
                    echo'<option value="'.$rs['name'].'"/>';?>
                  </datalist>
                  <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="saveattributionContentName" class="btn btn-secondary save" data-dbid="attributionContentName" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
                </div>
              </div>
              <div id="nav-content-content-25" class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="attributionContentURL">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
...
<?php $s=$db->query("SELECT DISTINCT attributionContentUrl as url FROM `".$prefix."content` ORDER BY attributionContentURL ASC");while($rs=$s->fetch(PDO::FETCH_ASSOC))
                    echo'<option value="'.$rs['url'].'"/>';?>
                  </datalist>
                  <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="saveattributionContentURL" class="btn btn-secondary save" data-dbid="attributionContentURL" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
                </div>
              </div>
            </fieldset>
          </div>
          ...
          <div id="tab-content-images" class="tab-pane" role="tabpanel">
            ...
            <fieldset id="tab-content-images-1" class="control-fieldset<?php echo$r['contentType']!='testimonials'?' hidden':'';?>">
              <div class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="av">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                  ...
                  <form target="sp" method="post" enctype="multipart/form-data" action="core/add_data.php">
                    ...
                    <div class="input-group-append"><div class="btn btn-secondary btn-file"><?php svg('libre-gui-browse-computer');?><input type="file" name="fu"></div></div>
                    <div class="input-group-append"><button class="btn btn-secondary" type="submit"><?php svg('libre-gui-upload',($config['iconsColor']==1?true:null));?></button></div>
                  </form>
                  <div class="input-group-append img"><img id="tstavatar" src="<?php echo$r['file']!=''&&file_exists('media'.DS.'avatar'.DS.basename($r['file']))?'media' . DS .'avatar'.DS.basename($r['file']):NOAVATAR;?>"></div>
                  <div class="input-group-append"><button class="btn btn-secondary trash" onclick="imageUpdate('<?php echo$r['id'];?>','content','file','');"><?php svg('libre-gui-trash');?></button></div>
                  <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="saveavatar" class="btn btn-secondary save" data-dbid="avatar" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
                </div>
              </div>
            </fieldset>
            <fieldset id="tab-content-images-2" class="control-fieldset<?php echo$r['contentType']=='testimonials'?' hidden':'';?>">
              <div id="tab-content-images-3" class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="fileURL">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                  ...
                  <div class="input-group-append"><button class="btn btn-secondary trash" onclick="imageUpdate('<?php echo$r['id'];?>','content','fileURL');"><?php svg('libre-gui-trash');?></button></div>
                </div>
              </div>
              <div class="help-block small text-muted text-right">Using the <span class="btn btn-secondary btn-sm"><?php svg('libre-gui-magic');?></span> button will resize the uploaded image. (<?php echo$config['mediaMaxWidth'].'x'.$config['mediaMaxHeight'];?>)</div>
              <div id="tab-content-images-4" class="form-group row">
                <label class="col-form-label col-sm-2"></label>
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="file">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                  <input id="file" type="text" class="form-control" value="<?php echo$r['file'];?>" readonly>
                  <div class="input-group-append"><button class="btn btn-secondary" onclick="elfinderDialog('<?php echo$r['id'];?>','content','file');"><?php svg('libre-gui-browse-media');?></button></div>
                  <form target="sp" method="post" action="core/magicimage.php">
                    <input type="hidden" name="id" value="<?php echo$r['id'];?>">
                    <input type="hidden" name="act" value="file">
                    <div class="input-group-append"><button class="btn btn-secondary"><?php svg('libre-gui-magic');?></button></div>
                  </form>
                  <div class="input-group-append img"><?php echo$r['file']!=''?'<a href="'.$r['file'].'" data-featherlight="image"><img id="thumbimage" src="'.$r['file'].'"></a>':'<img id="thumbimage" src="'.NOIMAGE.'">';?></div>
                  <div class="input-group-append"><button class="btn btn-secondary trash" onclick="imageUpdate('<?php echo$r['id'];?>','content','file');"><?php svg('libre-gui-trash');?></button></div>
                </div>
              </div>
              <div class="help-block small text-muted text-right">Using the <span class="btn btn-secondary btn-sm"><?php svg('libre-gui-magic');?></span> button will create a Thumbnail from the Center of the above uploaded image. (<?php echo$config['mediaMaxWidthThumb'].'x'.$config['mediaMaxHeightThumb'];?>). Uploaded Images take Precedence over URL's.</div>
              <div id="tab-content-images-5" class="form-group row">
                <label for="thumb" class="col-form-label col-sm-2">Thumbnail</label>
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="thumb">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                  <input id="thumb" type="text" class="form-control" value="<?php echo$r['thumb'];?>" readonly>
                  <div class="input-group-append"><button class="btn btn-secondary" onclick="elfinderDialog('<?php echo$r['id'];?>','content','thumb');"><?php svg('libre-gui-browse-media');?></button></div>
                  <form target="sp" method="post" action="core/magicimage.php">
                    <input type="hidden" name="id" value="<?php echo$r['id'];?>">
                    <input type="hidden" name="act" value="thumb">
                    <div class="input-group-append"><button class="btn btn-secondary"><?php svg('libre-gui-magic');?></button></div>
                  </form>
                  <div class="input-group-append img"><?php echo$r['thumb']!=''?'<a href="'.$r['thumb'].'" data-featherlight="image"><img id="thumbimage" src="'.$r['thumb'].'"></a>':'<img id="thumbimage" src="'.NOIMAGE.'">';?></div>
                  <div class="input-group-append"><button class="btn btn-secondary trash" onclick="imageUpdate('<?php echo$r['id'];?>','content','thumb');"><?php svg('libre-gui-trash');?></button></div>
                </div>
              </div>
            </fieldset>
            <fieldset id="tab-content-images-6" class="control-fieldset">
              ...
              <div id="tab-content-images-7" class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="exifFilename">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                  ...
                  <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="saveexifFilename" class="btn btn-secondary save" data-dbid="exifFilename" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
                </div>
              </div>
              <div id="tab-content-images-8" class="form-group row">
                <label for="exifCamera" class="col-form-label col-sm-2">Camera</label>
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="exifCamera">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                  ...
                  <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="saveexifCamera" class="btn btn-secondary save" data-dbid="exifCamera" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
                </div>
              </div>
              <div id="tab-content-images-9" class="form-group row">
                <label for="exifLens" class="col-form-label col-sm-2">Lens</label>
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="exifLens">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                  ...
                  <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="saveexifLens" class="btn btn-secondary save" data-dbid="exifLens" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
                </div>
              </div>
              <div id="tab-content-images-10" class="form-group row">
                <label for="exifAperture" class="col-form-label col-sm-2">Aperture</label>
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="exifAperture">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                  ...
                  <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="saveexifAperture" class="btn btn-secondary save" data-dbid="exifAperture" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
                </div>
              </div>
              <div id="tab-content-images-11" class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="exifFocalLength">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                  ...
                  <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="saveexifFocalLength" class="btn btn-secondary save" data-dbid="exifFocalLength" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
                </div>
              </div>
              <div id="tab-content-images-12" class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="exifShutterSpeed">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                  ...
                  <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="saveexifShutterSpeed" class="btn btn-secondary save" data-dbid="exifShutterSpeed" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
                </div>
              </div>
              <div id="tab-content-images-13" class="form-group row">
                <label for="exifISO" class="col-form-label col-sm-2">ISO</label>
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="exifISO">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                  ...
                  <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="saveexifISO" class="btn btn-secondary save" data-dbid="exifISO" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
                </div>
              </div>
              <div id="tab-content-images-14" class="form-group row">
                <label for="exifti" class="col-form-label col-sm-2">Taken</label>
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                  ...
                  <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="saveexifti" class="btn btn-secondary save" data-dbid="exifti" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
                </div>
              </div>
            </fieldset>
            <fieldset id="tab-content-images-15" class="control-fieldset">
              ...
              <div id="tab-content-images-16" class="form-group row">
                ...
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="attributionImageTitle">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
...
while($rs=$s->fetch(PDO::FETCH_ASSOC))
                  ...
                  <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="saveattributionImageTitle" class="btn btn-secondary save" data-dbid="attributionImageTitle" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
                </div>
              </div>
              <div id="tab-content-images-17" class="form-group row">
                <label for="attributionImageName" class="col-form-label col-sm-2">Name</label>
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="attributionImageName">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
...
while($rs=$s->fetch(PDO::FETCH_ASSOC))
                  ...
                  <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="saveattributionImageName" class="btn btn-secondary save" data-dbid="attributionImageName" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
                </div>
              </div>
              <div id="tab-content-images-18" class="form-group row">
                <label for="attributionImageURL" class="col-form-label col-sm-2">URL</label>
                <div class="input-group col-sm-10">
                  <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="attributionImageURL">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
...
while($rs=$s->fetch(PDO::FETCH_ASSOC))
                  ...
                  <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="saveattributionImageURL" class="btn btn-secondary save" data-dbid="attributionImageURL" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
                </div>
              </div>
            </fieldset>
          </div>
            ...
            <form target="sp" method="post" enctype="multipart/form-data" action="core/add_data.php">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <div class="input-group-append"><button class="btn btn-secondary" onclick="elfinderDialog('<?php echo$r['id'];?>','media','mediafile');return false;"><?php svg('libre-gui-browse-media');?></button></div>
                  <div class="input-group-append"><button type="submit" class="btn btn-secondary add" onclick=""><?php svg('libre-gui-plus');?></button></div>
                </div>
              </div>
            </form>
            <ul id="media_items">
              ...
              <div class="form-group">
                <form target="sp" method="post" action="core/add_data.php">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append"><button class="btn btn-secondary add"><?php svg('libre-gui-plus');?></button></div>
                  </div>
                </form>
              </div>
              <div id="itemoptions">
...
<?php $scc=$db->prepare("SELECT ip FROM `".$prefix."iplist` WHERE ip=:ip");
  $scc->execute(array(':ip'=>$rc['ip']));
  if($scc->rowCount()<1){?>
                      <form id="blacklist<?php echo$rc['id'];?>" target="sp" method="post" action="core/add_commentblacklist.php" style="display:inline-block;">
                        <input type="hidden" name="id" value="<?php echo$rc['id'];?>">
                        <button class="btn btn-default btn-sm" data-toggle="tooltip" title="Add this Commenters IP to the Blacklist."><?php echo svg2('libre-gui-security');?></button>
                      </form>
<?php }?>
                      <button id="approve_<?php echo$rc['id'];?>" class="btn btn-default btn-sm add<?php echo$rc['status']!='unapproved'?' hidden':'';?>" onclick="update('<?php echo$rc['id'];?>','comments','status','approved')" data-toggle="tooltip" title="Approve"><?php svg('libre-gui-approve');?></button>
                      <button class="btn btn-default btn-sm trash" onclick="purge('<?php echo$rc['id'];?>','comments')" data-toggle="tooltip" title="Delete"><?php svg('libre-gui-trash');?></button>
                    </div>
...
<?php /* SEO */ ?>
          <div id="tab-content-seo" class="tab-pane" role="tabpanel">
            <div id="tab-content-seo-1" class="form-group row">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="views">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                ...
                <div class="input-group-append"><button class="btn btn-secondary trash" onclick="$('#views').val('0');update('<?php echo$r['id'];?>','content','views','0');"><?php svg('libre-gui-eraser');?></button></div>
                <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="saveviews" class="btn btn-secondary save" data-dbid="views" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="metaRobots">'.svg2('libre-gui-fingerprint').'</button></div>':'';
if($r['suggestions']==1){
  $ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");$ss->execute(array(':rid'=>$r['id'],':t'=>'content',':c'=>'metaRobots'));
                echo$ss->rowCount()>0?'<div class="input-group-prepend" data-tooltip="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-secondary suggestion" data-dbgid="metaRobots">'.svg2('libre-gui-gui-lightbulb','','green').'</button></div>':'';}?>
                ...
                <?php echo$user['rank']>899?'<div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Add Suggestion"><button class="btn btn-secondary addsuggestion" data-dbgid="metaRobots">'.svg2('libre-gui-idea').'</button></div>':'';?>
                <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="savemetaRobots" class="btn btn-secondary save" data-dbid="metaRobots" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
              </div>
            </div>
            <div id="tab-content-seo-2" class="form-group row<?php echo($r['contentType']=='proofs'?' hidden':'');?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="schemaType">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
            ...
            <div class="form-group row">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="seoTitle">'.svg2('libre-gui-fingerprint').'</button></div>':'';
...
<?php if($r['suggestions']==1){
  ...
  $ss->execute(array(':rid'=>$r['id'],':t'=>'content',':c'=>'seoTitle'));
                echo$ss->rowCount()>0?'<div class="input-group-prepend" data-tooltip="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-secondary suggestion" data-dbgid="seoTitle">'.svg2('libre-gui-lightbulb').'</button></div>':'';
}?>
            ...
            <div id="tab-content-seo-3" class="form-group row">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="seoCaption">'.svg2('libre-gui-fingerprint').'</button></div>':'';
...
<?php if($r['suggestions']==1){
  ...
  $ss->execute(array(':rid'=>$r['id'],':t'=>'content',':c'=>'seoCaption'));
                echo$ss->rowCount()>0?'<div class="input-group-prepend" data-tooltip="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-secondary suggestion" data-dbgid="seoCaption">'.svg2('libre-gui-lightbulb').'</button></div>':'';
}?>
                ...
                <?php echo$user['rank']>899?'<div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Add Suggestion"><button class="btn btn-secondary addsuggestion" data-dbgid="seoCaption">'.svg2('libre-gui-idea').'</button></div>':'';?>
            ...
            <div id="tab-content-seo-4" class="form-group row">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="seoDescription">'.svg2('libre-gui-fingerprint').'</button></div>':'';
...
<?php if($r['suggestions']==1){
  ...
  $ss->execute(array(':rid'=>$r['id'],':t'=>'content',':c'=>'seoDescription'));
                echo$ss->rowCount()>0?'<div class="input-group-prepend" data-tooltip="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-secondary suggestion" data-dbgid="seoDescription">'.svg2('libre-gui-lightbulb').'</button></div>':'';
}?>
            ...
            <div id="tab-content-seo-5" class="form-group row<?php echo$r['contentType']=='proofs'?' hidden':'';?>">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="seoKeywords">'.svg2('libre-gui-fingerprint').'</button></div>':'';
if($r['suggestions']==1){
  $ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");
  $ss->execute(array(':rid'=>$r['id'],':t'=>'content',':c'=>'seoKeywords'));
                echo$ss->rowCount()>0?'<div class="input-group-prepend" data-tooltip="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-secondary suggestion" data-dbgid="seoKeywords">'.svg2('libre-gui-lightbulb').'</button></div>':'';
}?>
                ...
                <?php echo$user['rank']>899?'<div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Add Suggestion"><button class="btn btn-secondary addsuggestion" data-dbgid="seoKeywords">'.svg2('libre-gui-idea').'</button></div>':'';?>
            ...
            <div id="tab-content-seo-6" class="form-group row">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="tags">'.svg2('libre-gui-fingerprint').'</button></div>':'';
if($r['suggestions']==1){
  $ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");
  $ss->execute(array(':rid'=>$r['id'],':t'=>'content',':c'=>'tags'));
                echo$ss->rowCount()>0?'<div class="input-group-prepend" data-tooltip="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-secondary suggestion" data-dbgid="tags">'.svg2('libre-gui-lightbulb','','green').'</button></div>':'';
}?>
                ...
                <?php echo$user['rank']>899?'<div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Add Suggestion"><button class="btn btn-secondary addsuggestion" data-dbgid="tags">'.svg2('libre-gui-idea').'</button></div>':'';?>
                <div class="input-group-append" data-tooltip="tooltip" data-placement="top" title="Save"><button id="savetags" class="btn btn-secondary save" data-dbid="tags" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
              </div>
            </div>
          </div>
<?php /* Settings */ ?>
          <div id="tab-content-settings" class="tab-pane" role="tabpanel">
            ...
            <div id="tab-content-settings-2" class="form-group row">
              ...
              <div class="input-group col-sm-10">
                <?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="contentType">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
            ...
            <div id="tab-content-settings-4" class="form-group row<?php echo$r['contentType']=='portfolio'||$r['contentType']=='events'||$r['contentType']=='testimonials'||$r['contentType']=='gallery'?' hidden':'';?>">
            ...
            <div id="tab-content-settings-5" class="form-group row<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='inventory'||$r['contentType']=='gallery'||$r['contentType'] == 'proofs'?' hidden':'';?>">
