...
<div class="panel panel-default">
  <div class="panel-heading clearfix">
    ...
    <div class="btn-group pull-right">
      <?php if($help['preferences_text']!='')echo'<a target="_blank" class="btn btn-default info" href="'.$help['preferences_text'].'" data-toggle="tooltip" data-placement="left" title="Help">'.svg2('libre-gui-help').'</a>';if($help['preferences_video']!='')echo'<a href="#" class="btn btn-default info" data-toggle="modal" data-frame="iframe" data-target="#videoModal" data-video="'.$help['preferences_video'].'" data-tooltip="tooltip" data-placement="left" title="Watch Video Help">'.svg2('libre-gui-video').'</a>';?>
    </div>
  </div>
  <div id="update" class="panel-body">
    <ul class="nav nav-tabs">
      ...
      <li><a href="#preference-seo" data-toggle="tab">SEO<?php echo$config['suggestions']==1?'<span data-toggle="tooltip" data-placement="top" title="Editing suggestions.">'.svg2('libre-gui-lightbulb','','green').'</span>':'';?></a></li>
      <?php echo$user['rank']>899?'<li><a href="#preference-info" data-toggle="tab">PHP Info</a></li>':'';?>
    </ul>
    <div class="tab-content">
      <div id="preference-theme" name="preference-theme" class="tab-pane fade in active">
        <div class="btn-group pull-right">
          <?php if($help['template_text']!='')echo'<a target="_blank" class="btn btn-default info" href="'.$help['template_text'].'" data-toggle="tooltip" data-placement="left" title="Help">'.svg2('libre-gui-help').'</a>';if($help['template_video']!='')echo'<span><a href="#" class="btn btn-default info" data-toggle="modal" data-frame="iframe" data-target="#videoModal" data-video="'.$help['template_video'].'" data-tooltip="tooltip" data-placement="left" title="Watch Video Help">'.svg2('libre-gui-video').'</a>';?>
        </div>
...
<?php }?>
      ...
      <div id="preference-contact" name="preference-contact" class="tab-pane fade in">
        ...
        <div class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="abn">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="mobile">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="country">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
            ...
            <div class="form-group">
              ...
              <div class="input-group col-xs-7 col-sm-9 col-lg-10">
                <div class="input-group-btn">
                    ...
                    <button class="btn btn-default trash" onclick="purge('0','errorlog')" data-toggle="tooltip" title="This will Remove the Error Logs, there is no getting it back.">><?php svg('libre-gui-purge');?></button>
                </div>
              </div>
            </div>
...
<?php }
        ...
        <div id="updatecheck" class="col-xs-7 col-sm-9 col-lg-10 pull-right hidden">
          <div class="alert alert-warning"><?php svg('libre-gui-spinner-13','animated spin');?> Checking for new updates!</div>
        </div>
        <div class="clearfix"></div>
        <div class="form-group">
          <label for="update_url" class="control-label col-xs-5 col-sm-3 col-lg-2">Update URL</label>
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="update_url">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="dateFormat">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
...
if($cntc<0){
  ...
  $cnt=number_format($cnt)*-1;
            ...
            <?php if($config['suggestions']==1){$ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");$ss->execute(array(':rid'=>1,':t'=>'config',':c'=>'seoTitle'));echo$ss->rowCount()>0?'<div class="input-group-btn" data-toggle="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-default suggestion hidden-xs" data-toggle="popover" data-dbgid="seoTitle">'.svg2('libre-gui-lightbulb','','green').'</button></div>':'';}?>
...
if($cntc<0){
  ...
  $cnt=number_format($cnt)*-1;
            ...
            <?php if($config['suggestions']==1){$ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");$ss->execute(array(':rid'=>1,':t'=>'config',':c'=>'seoCaption'));echo$ss->rowCount()>0?'<div class="input-group-btn" data-toggle="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-default suggestion hidden-xs" data-toggle="popover" data-dbgid="seoCaption">'.svg2('libre-gui-lightbulb','','green').'</button></div>':'';}?>
...
if($cntc<0){
  ...
  $cnt=number_format($cnt)*-1;
            ...
            <?php if($config['suggestions']==1){$ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");$ss->execute(array(':rid'=>1,':t'=>'config',':c'=>'seoDescription'));echo$ss->rowCount()>0?'<div class="input-group-btn" data-toggle="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-default suggestion hidden-xs" data-toggle="popover" data-dbgid="seoDescription">'.svg2('libre-gui-lightbulb','','green').'</button></div>':'';}?>
        ...
        <div class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            ...
            if($config['suggestions']==1){$ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");$ss->execute(array(':rid'=>1,':t'=>'config',':c'=>'seoKeywords'));echo$ss->rowCount()>0?'<div class="input-group-btn" data-toggle="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-default suggestion hidden-xs" data-toggle="popover" data-dbgid="seoKeywords">'.svg2('libre-gui-lightbulb','','green').'</button></div>':'';}?>
        ...
        <div class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="ga_verification">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div class="form-group">
          ...
          <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs" style="background-color:#f5f5f5;border:1px solid #ccc;border-bottom:0;"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="ga_tracking">'.svg2('libre-gui-fingerprint').'</button></div><div id="da" class="hidden-xs" data-dbid="1" data-dbt="config" data-dbc="ga_tracking"></div>':'';?>
          <form target="sp" method="post" action="core/update.php" onsubmit="Pace.restart();$('#ga_tracking_save').removeClass('btn-danger');">
            ...
            <div class="input-group col-xs-7 col-sm-9 col-lg-10 pull-right" style="background-color:#f5f5f5;padding:5px;border:1px solid #ccc;border-bottom:0;">
              <button type="submit" id="ga_tracking_save" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="bottom" title="Save"><?php svg('libre-gui-save');?></button>
            </div>
        ...
        <div class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="seo_msvalidate">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="seo_yandexverification">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="seo_alexaverification">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="seo_domainverify">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="geo_region">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="geo_placename">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="geo_position">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
