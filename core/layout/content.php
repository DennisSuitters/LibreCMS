...
<?php $cntc=70-strlen($r['seoTitle']);if($cntc<0){$cnt=abs($cntc);$cnt=number_format($cnt)*-1;}else{$cnt=number_format($cntc);}?>
              ...
              <small class="help-block col-xs-7 col-sm-9 col-lg-10 pull-right">The recommended character count for Title's is 70.</small>
            </div>
...
<?php $cntc=160-strlen($r['seoCaption']);if($cntc<0){$cnt=abs($cntc);$cnt=number_format($cnt)*-1;}else{$cnt=number_format($cntc);}?>
              ...
              <small class="help-block col-xs-7 col-sm-9 col-lg-10 pull-right">The recommended character count for Captions is 160, as sometime Captions may be used in Descriptions.</small>
            </div>
...
<?php $cntc=160-strlen($r['seoDescription']);if($cntc<0){$cnt=abs($cntc);$cnt=number_format($cnt)*-1;}else{$cnt=number_format($cntc);}?>
              ...
              <small class="help-block col-xs-7 col-sm-9 col-lg-10 pull-right">The recommended character count for Descriptions is 160.</small>
            </div>
