...
if($user['layoutContent']=='')$user['layoutContent']=$config['layoutContent'];?>
    <div class="pull-right">
        <div class="btn-group"<?php if($config['options']{4}==1)echo' data-toggle="tooltip" data-placement="left" title="Items"';?>>
...
<?php $st=$db->query("SELECT DISTINCT contentType FROM content WHERE contentType!='booking' AND contentType!='message' AND contentType!='message_primary' ORDER BY contentType ASC");while($sr=$st->fetch(PDO::FETCH_ASSOC))echo'<li><a href="'.URL.$settings['system']['admin'].'/content/type/'.$sr['contentType'].'">'.ucfirst($sr['contentType']);?></a></li>
            </ul>
        </div>
...
<?php }?>
                        ...
                        <td id="controls_<?php echo$r['id'];?>" class="text-right">
                            ...
                            <a class="btn btn-info btn-sm" href="<?php echo URL.$settings['system']['admin'];?>/content/edit/<?php echo$r['id'];?>"<?php if($config['options']{4}==1)echo' data-toggle="tooltip" title="Edit"';?>><i class="libre libre-edit"></i></a>
<?php if($user['rank']==1000||$user['options']{0}==1){?>
...
<?php }?>
    ...
    <div class="pull-right">
        <div class="btn-group">
            <a class="btn btn-success" href="<?php echo URL.$settings['system']['admin'].'/content/type/'.$r['contentType'];?>"<?php if($config['options']{4}==1)echo' data-toggle="tooltip" data-placement="left" title="Back"';?>><i class="libre libre-back"></i></a>
        </div>
<?php if($user['rank']==1000||$user['options']{0}==1){?>
        <div class="btn-group"<?php if($config['options']{4}==1)echo' data-toggle="tooltip" data-placement="left" title="Add"';?>>
            <button class="btn btn-success dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="libre libre-add"></i></button>
...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <div id="d1" class="form-group<?php if($r['contentType']=='proofs')echo' hidden';?>">
        ...
        <div id="d2" class="form-group<?php if($r['contentType']!='proofs'||$r['contentType']!='testimonials')echo' hidden';?>">
            <label for="cid" class="control-label col-xs-5 col-lg-2">Client</label>
            <div class="input-group col-xs-7 col-lg-10">
...
<?php }?>
        ...
        <div id="d3" class="form-group<?php if($r['contentType']!='article')echo' hidden';?>">
        ...
        <fieldset id="d4" class="control-fieldset<?php
if($r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='testimonials')echo' hidden';?>">
...
<?php if($r['thumb']!=''&&file_exists('media/'.$r['thumb']))echo'<a href="media/'.$r['thumb'].'" data-featherlight="image"><img src="media/'.$r['thumb'].'"></a>';
        ...
        <div id="d5" class="form-group<?php
if($r['contentType']!='inventory'||$r['contentType']!='service'||$r['contentType']!='events'||$r['contentType']!='news')echo' hidden';?>">
        ...
        <div id="d6" class="form-group<?php if($r['contentType']!='inventory')echo' hidden';?>">
        ...
        <div id="d7" class="form-group<?php if($r['contentType']!='inventory')echo' hidden';?>">
            ...
            <div class="help-block col-xs-7 col-sm-9 col-lg-10 pull-right"><a target="_blank" href="https://fccid.io/">fccid.io</a> for more information or to look up an FCC ID.</div>
        </div>
        <div id="d8" class="form-group<?php if($r['contentType']!='inventory')echo' hidden';?>">
        ...
        <div id="d9" class="form-group<?php if($r['contentType']!='events')echo' hidden';?>">
        ...
        <div id="d10" class="form-group<?php if($r['contentType']!='events')echo' hidden';?>">
        ...
        <div id="d11" class="form-group<?php if($r['contentType']!='testimonials')echo' hidden';?>">
        ...
        <div id="d12" class="form-group<?php
if($r['contentType']!='testimonials'||$r['contentType']!='news')echo' hidden';?>">
        ...
        <div id="d13" class="form-group<?php if($r['contentType']!='testimonials'||$r['contentType']!='news')echo' hidden';?>">
        ...
        <div id="d14" class="form-group<?php if($r['contentType']!='news'||$r['contentType']!='proofs')echo' hidden';?>">
        ...
        <div id="d15" class="form-group<?php if($r['contentType']!='article'||$r['contentType']=='portfolio'||$r['contentType']!='gallery'||$r['contentType']!='inventory'||$r['contentType']!='service'||$r['contentType']!='events'||$r['contentType']!='news')echo' hidden';?>">
        ...
        <div id="d16" class="form-group<?php if($r['contentType']!='article'||$r['contentType']=='portfolio'||$r['contentType']!='gallery'||$r['contentType']!='inventory'||$r['contentType']!='service'||$r['contentType']!='events'||$r['contentType']!='news')echo' hidden';?>">
        ...
        <div id="d17" class="form-group<?php if($r['contentType']!='inventory'||$r['contentType']!='service')echo' hidden';?>">
        ...
        <div id="d18" class="form-group clearfix<?php if($r['contentType']!='inventory'||$r['contentType']!='service')echo' hidden';?>">
        ...
        <div id="d19" class="form-group<?php if($r['contentType']!='inventory')echo' hidden';?>">
        ...
        <div id="d20" class="form-group<?php if($r['contentType']!='article'||$r['contentType']!='portfolio'||$r['contentType']!='inventory'||$r['contentType']!='service'||$r['contentType']!='gallery'||$r['contentType']!='events'||$r['contentType']!='news')echo' hidden';?>">
        ...
        <div id="d21" class="form-group<?php if($r['contentType']!='article'||$r['contentType']!='portfolio'||$r['contentType']!='inventory'||$r['contentType']!='service'||$r['contentType']!='gallery'||$r['contentType']!='events'||$r['contentType']!='news')echo' hidden';?>">
        ...
        <div id="d22" class="form-group clearfix<?php if($r['contentType']!='events'||$r['contentType']!='service')echo' hidden';?>">
        ...
        <div id="d23" class="form-group<?php if($r['contentType']!='article'||$r['contentType']=='gallery'||$r['contentType']!='service'||$r['contentType']!='inventory'||$r['contentType']!='portfolio'||$r['contentType']!='events'||$r['contentType']!='news')echo' hidden';?>">
...
<?php }?>
        ...
        <div class="clearfix"></div>
        <div id="d24" class="form-group clearfix<?php if($r['contentType']!='article'||$r['contentType']!='events'||$r['contentType']!='news'||$r['contentType']!='proofs')echo' hidden';?>">
