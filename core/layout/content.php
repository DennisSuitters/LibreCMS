...
<?php if($user['rank']==1000||$user['options']{0}==1){?>
      <button class="btn btn-default add dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" data-tooltip="tooltip" data-placement="left" title="Add"><?php svg('libre-gui-add');?></button>
      <ul class="dropdown-menu">
      ...
      <a class="btn btn-default" href="<?php echo URL.$settings['system']['admin'].'/content/settings';?>" data-toggle="tooltip" data-placement="left" title="Settings"><?php svg('libre-gui-settings');?></a>
<?php }?>
      <?php if($help['content_text']!='')echo'<a class="btn btn-default info" target="_blank" href="'.$help['content_text'].'" data-toggle="tooltip" data-placement="left" title="Help">'.svg2('libre-gui-help').'</a>';if($help['content_video']!='')echo'<a href="#" class="btn btn-default info" data-toggle="modal" data-frame="iframe" data-target="#videoModal" data-video="'.$help['content_video'].'" data-tooltip="tooltip" data-placement="left" title="Watch Video Help">'.svg2('libre-gui-video').'</a>';?>
    </div>
  </div>
...
<?php if($r['contentType']=='article'||$r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='proofs'){
  ...
  echo'<a class="btn btn-default'.($sccc>0?' btn-success':'').'" href="'.URL.$settings['system']['admin'].'/content/edit/'.$r['id'].'#d43"'.($sccc>0?' data-toggle="tooltip" title="'.$sccc.' New Comments"':'').'>'.svg2('libre-gui-comments').$cnt['cnt'].'</a>';
}?>
            </td>
            <td class="text-center hidden-xs">
...
echo$rr['num'] > 0?'<a class="btn btn-default'.($src>0?' btn-success':'').'" href="'.URL.$settings['system']['admin'].'/content/edit/'.$r['id'].'#d60"'.($src>0?' data-toggle="tooltip" title="'.$src.' New Reviews"':'').'>'.$rr['num'] .'/'.$rr['cnt'].'</a>':'';?>
            ...
            <td class="text-center hidden-xs">
              <button class="btn btn-default trash" onclick="$('#views<?php echo$r['id'];?>').text('0');update('<?php echo$r['id'];?>','content','views','0');"><?php svg('libre-gui-eraser');?> <span id="views<?php echo$r['id'];?>"><?php echo$r['views'];?></span></button>
            </td>
            <td id="controls_<?php echo$r['id'];?>">
              <div class="btn-group pull-right">
                <a id="pin<?php echo$r['id'];?>" class="btn btn-default<?php echo$r['pin']{0}==1?' btn-success':'';?> hidden-xs" onclick="pinToggle('<?php echo$r['id'];?>','content','pin','0')" data-toggle="tooltip" title="Pin"><?php svg('libre-gui-pin');?></a>
                <a class="btn btn-default" href="<?php echo URL.$settings['system']['admin'];?>/content/edit/<?php echo$r['id'];?>" data-toggle="tooltip" title="Edit"><?php svg('libre-gui-edit');?></a>
<?php if($user['rank']==1000||$user['options']{0}==1){?>
  ...
  <div class="panel-heading clearfix">
    <h4 class="col-xs-8">
      <ol class="breadcrumb">
        ...
        <li class="active relative">
<?php $so=$db->prepare("SELECT id,contentType,title FROM `".$prefix."content` WHERE contentType LIKE :contentType AND id NOT LIKE :id ORDER BY title ASC, ti DESC");
  $so->execute(
    array(
      ':id'=>$r['id'],
      ':contentType'=>$r['contentType'].'%'
...
<?php }?>
    ...
    <div class="btn-group pull-right">
      <a class="btn btn-default" href="<?php echo$r['contentType']=='proofs'?URL.$settings['system']['admin'].'/accounts/edit/'.$r['uid'].'#account-proofs':URL.$settings['system']['admin'].'/content/type/'.$r['contentType'];?>" data-toggle="tooltip" data-placement="left" title="Back"><?php svg('libre-gui-back');?></a>
<?php if($user['rank']==1000||$user['options']{0}==1){?>
      <button class="btn btn-default add dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" data-tooltip="tooltip" data-placement="left" title="Add"><?php svg('libre-gui-add');?></button>
...
<?php }?>
      <?php if($help['content_edit_text']!='')echo'<a target="_blank" class="btn btn-default info" href="'.$help['content_edit_text'].'" data-toggle="tooltip" data-placement="left" title="Help">'.svg2('libre-gui-help').'</a>';if($help['content_edit_video']!='')echo'<a href="#" class="btn btn-default info" data-toggle="modal" data-frame="iframe" data-target="#videoModal" data-video="'.$help['content_edit_video'].'" data-tooltip="tooltip" data-placement="left" title="Watch Video Help">'.svg2('libre-gui-video').'</a>';?>
    </div>
  </div>
  <div class="panel-body">
...
if($r['suggestions']==1){
  ...
  echo$ss->rowCount()>0?'<div class="input-group-btn" data-toggle="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-default suggestion hidden-xs" data-toggle="popover" data-dbgid="title">'.svg2('libre-gui-lightbulb','','green').'</button></div>':'';
}?>
        ...
        <div id="d5" class="form-group<?php echo$r['contentType']=='article'||$r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='inventory'||$r['contentType']=='service' || $r['contentType']=='gallery'?' hidden':'';?>">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="cid">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div id="d6" class="form-group<?php echo$r['contentType']=='portfolio'||$r['contentType']=='events'||$r['contentType']=='testimonials'||$r['contentType']=='inventory'||$r['contentType']=='service'?' hidden':'';?>">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="uid">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div id="d7" class="form-group<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?>">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="code">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div id="d8" class="form-group<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?>">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="barcode">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div id="d9" class="form-group<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='service'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?> clearfix">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="fccid">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div id="d10" class="form-group<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='service'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?>">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="brand">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div id="d14" class="form-group<?php echo$r['contentType']=='article'||$r['contentType']=='news'||$r['contentType']=='inventory'||$r['contentType']=='service'||$r['contentType']=='gallery'?' hidden':'';?>">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            ...
            <datalist id="name_options">
              <?php $s=$db->query("SELECT DISTINCT name FROM `".$prefix."content` UNION SELECT DISTINCT name FROM `".$prefix."login` ORDER BY name ASC");while($rs=$s->fetch(PDO::FETCH_ASSOC))echo'<option value="'.$rs['name'].'"/>';?>
            </datalist>
          </div>
        </div>
        <div id="d15" class="form-group<?php echo$r['contentType']=='article'||$r['contentType']=='news'||$r['contentType']=='inventory'||$r['contentType']=='service'||$r['contentType']=='gallery'?' hidden':'';?>">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="url">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div id="d17" class="form-group<?php echo$r['contentType']=='testimonials'?' hidden':'';?>">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="category_1">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div id="d18" class="form-group<?php echo$r['contentType']=='testimonials'?' hidden':'';?>">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="category_2">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div id="d19" class="form-group<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?>">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="cost">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div id="d21" class="form-group<?php echo$r['contentType']=='article'||$r['contentType']=='portfolio'||$r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='service'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?>">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="quantity">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div id="d23" class="form-group">
          <div class="input-group col-xs-12" style="background-color:#f5f5f5;border-top:1px solid #a9a9a9">
            <div class="input-group-btn">
              <?php echo$user['rank']>899?'<button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="notesda">'.svg2('libre-gui-fingerprint').'</button>':'';
              if($r['suggestions']==1){$ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");$ss->execute(array(':rid'=>$r['id'],':t'=>'content',':c'=>'notes'));echo$ss->rowCount()>0?'<span data-toggle="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-default suggestion hidden-xs" data-toggle="popover" data-dbgid="notesda">'.svg2('libre-gui-lightbulb','','green').'</button></span>':'';}echo$user['rank']>899?'<span class="pull-right" data-toggle="tooltip" data-placement="top" title="Add Suggestion"><button class="btn btn-default addsuggestion pull-right hidden-xs" data-toggle="popover" data-dbgid="notesda">'.svg2('libre-gui-idea').'</button></span>':'';?>
            </div>
          </div>
        ...
        <fieldset id="d24" class="control-fieldset<?php echo$r['contentType']=='portfolio'||$r['contentType']=='events'||$r['contentType']=='news'||$r['contentType']=='testimonials'||$r['contentType']=='inventory'||$r['contentType']=='service'||$r['contentType']=='gallery'||$r['contentType']=='proofs'?' hidden':'';?>">
          ...
          <div id="d25" class="form-group">
            ...
            <div class="input-group col-xs-7 col-sm-9 col-lg-10">
              <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="attributionContentName">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
          ...
          <div id="d25" class="form-group">
            ...
            <div class="input-group col-xs-7 col-sm-9 col-lg-10">
              <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="attributionContentURL">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
      ...
      <div id="d26" role="tabpanel" class="tab-pane">
        ...
        <fieldset id="d26t" class="control-fieldset<?php echo$r['contentType']!='testimonials'?' hidden':'';?>">
          <div class="form-group">
            ...
            <div class="input-group col-xs-7 col-sm-9 col-lg-10">
              <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="av">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
              ...
              <div class="input-group-btn">
                <button class="btn btn-default trash" onclick="imageUpdate('<?php echo$r['id'];?>','content','file','');"><?php svg('libre-gui-trash');?></button>
              </div>
            </div>
          </div>
        </fieldset>
        <fieldset id="d26nt" class="control-fieldset<?php echo$r['contentType']=='testimonials'?' hidden':'';?>">
          <div id="d27" class="form-group">
            ...
            <div class="input-group col-xs-7 col-sm-9 col-lg-10">
              <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="fileURL">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
              ...
              <div class="input-group-btn">
                <button class="btn btn-default trash" onclick="imageUpdate('<?php echo$r['id'];?>','content','fileURL');"><?php svg('libre-gui-trash');?></button>
              </div>
            </div>
          </div>
          <div id="d28" class="form-group clearfix">
            <div class="input-group col-xs-7 col-sm-9 col-lg-10 pull-right">
              <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="file">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
              ...
              <div class="input-group-btn">
                <form target="sp" method="post" action="core/magicimage.php">
                  ...
                  <button class="btn btn-default"><?php svg('libre-gui-magic');?></button>
                </form>
              </div>
              <div class="input-group-addon img">
            ...
            <small class="help-block pull-right">Using the <span class="btn btn-default btn-xs"><?php svg('libre-gui-magic');?></span> button will resize the uploaded image. (<?php echo$config['mediaMaxWidth'].'x'.$config['mediaMaxHeight'];?>)</small>
          </div>
          <div id="d29" class="form-group clearfix">
            <label for="thumb" class="control-label col-xs-5 col-sm-3 col-lg-2">Thumbnail</label>
            <div class="input-group col-xs-7 col-sm-9 col-lg-10 pull-right">
              <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="thumb">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
              ...
              <div class="input-group-btn">
                <button class="btn btn-default trash" onclick="imageUpdate('<?php echo$r['id'];?>','content','thumb');"><?php svg('libre-gui-trash');?></button>
              </div>
            </div>
            <small class="help-block pull-right">Using the <span class="btn btn-default btn-xs"><?php svg('libre-gui-magic');?></span> button will create a Thumbnail from the Center of the above uploaded image. (<?php echo$config['mediaMaxWidthThumb'].'x'.$config['mediaMaxHeightThumb'];?>). Uploaded Images take Precedence over URL's.</small>
          </div>
          <fieldset id="d30" class="control-fieldset">
            ...
            <div class="clearfix">
              <small class="help-block col-xs-7 col-sm-9 col-lg-10 pull-right text-right">
                Using the <span class="btn btn-default btn-xs"><?php svg('libre-gui-magic');?></span> will attempt to get the EXIF Information embedded in the Uploaded Image.
              </small>
            </div>
            <div id="d31" class="form-group">
              <label for="exifFilename" class="control-label col-xs-5 col-sm-3 col-lg-2">Original Filename</label>
              <div class="input-group col-xs-7 col-sm-9 col-lg-10">
                <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="exifFilename">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                <div class="input-group-btn">
            ...
            <div id="d32" class="form-group">
              ...
              <div class="input-group col-xs-7 col-sm-9 col-lg-10">
                <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="exifCamera">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                <div class="input-group-btn">
                  <button class="btn btn-default" onclick="getExif('<?php echo$r['id'];?>','content','exifCamera');"><?php svg('libre-gui-magic');?></button>
                </div>
            ...
            <div id="d33" class="form-group">
              ...
              <div class="input-group col-xs-7 col-sm-9 col-lg-10">
                <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="exifLens">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                <div class="input-group-btn">
                  <button class="btn btn-default" onclick="getExif('<?php echo$r['id'];?>','content','exifLens');"><?php svg('libre-gui-magic');?></button>
                </div>
            ...
            <div id="d34" class="form-group">
              ...
              <div class="input-group col-xs-7 col-sm-9 col-lg-10">
                <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="exifAperture">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                <div class="input-group-btn">
            ...
            <div id="d35" class="form-group">
              ...
              <div class="input-group col-xs-7 col-sm-9 col-lg-10">
                <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="exifFocalLength">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                <div class="input-group-btn">
                  <button class="btn btn-default" onclick="getExif('<?php echo$r['id'];?>','content','exifFocalLength');"><?php svg('libre-gui-magic');?></button>
                </div>
            ...
            <div id="d36" class="form-group">
              ...
              <div class="input-group col-xs-7 col-sm-9 col-lg-10">
                <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="exifShutterSpeed">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                <div class="input-group-btn">
                  <button class="btn btn-default" onclick="getExif('<?php echo$r['id'];?>','content','exifShutterSpeed');"><?php svg('libre-gui-magic');?></button>
                </div>
            ...
            <div id="d37" class="form-group">
              ...
              <div class="input-group col-xs-7 col-sm-9 col-lg-10">
                <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="exifISO">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                <div class="input-group-btn">
            ...
            <div id="d38" class="form-group">
              ...
              <div class="input-group col-xs-7 col-sm-9 col-lg-10">
                <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                <div class="input-group-btn">
                  <button class="btn btn-default" onclick="getExif('<?php echo$r['id'];?>','content','exifti');"><?php svg('libre-gui-magic');?></button>
                </div>
          ...
          <fieldset id="d39" class="control-fieldset">
            ...
            <div id="d40" class="form-group">
              ...
              <div class="input-group col-xs-7 col-sm-9 col-lg-10">
                <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="attributionImageTitle">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
                ...
                <datalist id="attributionImageTitle_option">
                  <?php $s=$db->query("SELECT DISTINCT attributionImageTitle FROM `".$prefix."content` ORDER BY attributionImageTitle ASC");while($rs=$s->fetch(PDO::FETCH_ASSOC))echo'<option value="'.$rs['attributionImageTitle'].'"/>';?>
                </datalist>
              </div>
            </div>
            <div id="d41" class="form-group">
              ...
              <div class="input-group col-xs-7 col-sm-9 col-lg-10">
                <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="attributionImageName">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
            ...
            <div id="d42" class="form-group">
              ...
              <div class="input-group col-xs-7 col-sm-9 col-lg-10">
                <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="attributionImageURL">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <form target="sp" method="post" enctype="multipart/form-data" action="core/add_data.php">
          ...
          <div class="form-group">
            <div class="input-group">
              ...
              <div class="input-group-btn">
                <button class="btn btn-default" onclick="elfinderDialog('<?php echo$r['id'];?>','media','mediafile');return false;"><?php svg('libre-gui-browse-media');?></button>
              </div>
              <div class="input-group-btn">
          ...
          <div class="form-group">
            <form target="sp" method="post" action="core/add_data.php">
              ...
              <div class="input-group col-xs-12">
                ...
                <div class="input-group-btn">
                  <button class="btn btn-default add"><?php svg('libre-gui-plus');?></button>
                </div>
              </div>
            </form>
          </div>
...
while($rr=$sr->fetch(PDO::FETCH_ASSOC)){?>
          ...
          <div class="media-body well">
            ...
            <div id="controls-<?php echo$rr['id'];?>" class="btn-group pull-right">
              <button id="approve_<?php echo$rr['id'];?>" class="btn btn-default btn-sm<?php echo$rr['status']=='approved'?' hidden':'';?>" onclick="update('<?php echo$rr['id'];?>','comments','status','approved')" data-toggle="tooltip" title="Approve"><?php svg('libre-gui-approve');?></button>
              <button class="btn btn-default btn-sm trash" onclick="purge('<?php echo$rr['id'];?>','comments')" data-toggle="tooltip" title="Delete"><?php svg('libre-gui-trash');?></button>
            </div>
...
<?php }?>
      ...
      <div id="d44" role="tabpanel" class="tab-pane">
        <div class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <div class="input-group-btn">
              <button class="btn btn-default analytics hidden-xs" data-toggle="analytics" data-id="<?php echo$r['id'];?>" data-t="content" data-u="<?php echo URL.$r['contentType'].'/'.strtolower(str_replace(' ','-',$r['title']));?>" data-analytics="social"><?php svg('libre-seo-social');?> Social</button>
              <button class="btn btn-default analytics hidden-xs" data-toggle="analytics" data-id="<?php echo$r['id'];?>" data-t="content" data-u="<?php echo URL.$r['contentType'].'/'.strtolower(str_replace(' ','-',$r['title']));?>" data-analytics="google"><?php svg('libre-seo-google');?> Google</button>
              <button class="btn btn-default analytics hidden-xs" data-toggle="analytics" data-id="<?php echo$r['id'];?>" data-t="content" data-u="<?php echo URL.$r['contentType'].'/'.strtolower(str_replace(' ','-',$r['title']));?>" data-analytics="alexa"><?php svg('libre-seo-alexa');?> Alexa</button>
              <button class="btn btn-default analytics hidden-xs" data-toggle="analytics" data-id="<?php echo$r['id'];?>" data-t="content" data-u="<?php echo URL.$r['contentType'].'/'.strtolower(str_replace(' ','-',$r['title']));?>" data-analytics="moz"><?php svg('libre-seo-moz');?> Moz</button>
            </div>
          </div>
        </div>
        <script>/*<![CDATA[*/
        ...
        <div id="d45" class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="views">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
            ...
            <div class="input-group-btn">
              <button class="btn btn-default trash" onclick="$('#views').val('0');update('<?php echo$r['id'];?>','content','views','0');"><?php svg('libre-gui-eraser');?></button>
            </div>
          </div>
        </div>
        <div class="form-group clearfix">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="metaRobots">'.svg2('libre-gui-fingerprint').'</button></div>':'';if($r['suggestions']==1){$ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");$ss->execute(array(':rid'=>$r['id'],':t'=>'content',':c'=>'metaRobots'));echo$ss->rowCount()>0?'<div class="input-group-btn" data-toggle="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-default suggestion hidden-xs" data-toggle="popover" data-dbgid="metaRobots">'.svg2('libre-gui-gui-lightbulb','','green').'</button></div>':'';}?>
        ...
        <div id="d46" class="form-group<?php echo($r['contentType']=='proofs'?' hidden':'');?>">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="schemaType">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div class="form-group clearfix">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="seoTitle">'.svg2('libre-gui-fingerprint').'</button></div>':'';
...
if($cntc<0){
  ...
  $cnt=number_format($cnt)*-1;
            ...
            <?php if($r['suggestions']==1){$ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");$ss->execute(array(':rid'=>$r['id'],':t'=>'content',':c'=>'seoTitle'));echo$ss->rowCount()>0?'<div class="input-group-btn" data-toggle="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-default suggestion hidden-xs" data-toggle="popover" data-dbgid="seoTitle">'.svg2('libre-gui-lightbulb','','green').'</button></div>':'';}?>
        ...
        <div id="d49" class="form-group clearfix">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="seoCaption">'.svg2('libre-gui-fingerprint').'</button></div>':'';
...
if($cntc<0){
  ...
  $cnt=number_format($cnt)*-1;
            ...
            <?php if($r['suggestions']==1){$ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");$ss->execute(array(':rid'=>$r['id'],':t'=>'content',':c'=>'seoCaption'));echo$ss->rowCount()>0?'<div class="input-group-btn" data-toggle="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-default suggestion hidden-xs" data-toggle="popover" data-dbgid="seoCaption">'.svg2('libre-gui-lightbulb','','green').'</button></div>':'';}?>
        ...
        <div id="d49a" class="form-group clearfix">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="seoDescription">'.svg2('libre-gui-fingerprint').'</button></div>':'';
...
if($cntc<0){
  ...
  $cnt=number_format($cnt)*-1;
            ...
            <?php if($r['suggestions']==1){$ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");$ss->execute(array(':rid'=>$r['id'],':t'=>'content',':c'=>'seoDescription'));echo$ss->rowCount()>0?'<div class="input-group-btn" data-toggle="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-default suggestion hidden-xs" data-toggle="popover" data-dbgid="seoDescription">'.svg2('libre-gui-lightbulb','','green').'</button></div>':'';}?>
        ...
        <div id="d47" class="form-group<?php echo$r['contentType']=='proofs'?' hidden':'';?>">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="seoKeywords">'.svg2('libre-gui-fingerprint').'</button></div>':'';
            if($r['suggestions']==1){$ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");$ss->execute(array(':rid'=>$r['id'],':t'=>'content',':c'=>'seoKeywords'));echo$ss->rowCount()>0?'<div class="input-group-btn" data-toggle="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-default suggestion hidden-xs" data-toggle="popover" data-dbgid="seoKeywords">'.svg2('libre-gui-lightbulb','','green').'</button></div>':'';}?>
        ...
        <div id="d48" class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="tags">'.svg2('libre-gui-fingerprint').'</button></div>':'';
            if($r['suggestions']==1){$ss=$db->prepare("SELECT rid FROM `".$prefix."suggestions` WHERE rid=:rid AND t=:t AND c=:c");$ss->execute(array(':rid'=>$r['id'],':t'=>'content',':c'=>'tags'));echo$ss->rowCount()>0?'<div class="input-group-btn" data-toggle="tooltip" data-placement="top" title="Suggestions"><button class="btn btn-default suggestion hidden-xs" data-toggle="popover" data-dbgid="tags">'.svg2('libre-gui-lightbulb','','green').'</button></div>':'';}?>
            ...
            <?php echo$user['rank']>899?'<div class="input-group-btn" data-toggle="tooltip" data-placement="top" title="Add Suggestion"><button class="btn btn-default addsuggestion hidden-xs" data-toggle="popover" data-dbgid="tags">'.svg2('libre-gui-idea').'</button></div>':'';?>
          </div>
        </div>
      </div>
      <div id="d50" role="tabpanel" class="tab-pane">
        ...
        <div id="d52" class="form-group">
          ...
          <div class="input-group col-xs-7 col-sm-9 col-lg-10">
            <?php echo$user['rank']>899?'<div class="input-group-btn hidden-xs"><button class="btn btn-default fingerprint" data-toggle="popover" data-dbgid="contentType">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
