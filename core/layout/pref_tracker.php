...
<main id="content" class="main">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><strong>Tracker</strong></li>
    <li class="breadcrumb-menu">
      <div class="btn-group" role="group" aria-label="">
        ...
        if($help['tracker_video']!='')echo'<a href="#" class="btn btn-ghost-normal info" data-toggle="modal" data-frame="iframe" data-target="#videoModal" data-video="'.$help['tracker_video'].'" data-toggle="tooltip" data-placement="left" title="Watch Video Help" savefrom_lm="false">'.svg2('libre-gui-video').'</a>';?>
      </div>
    </li>
  </ol>
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-condensed table-striped table-hover">
            <thead>
              <tr>
                <th class="" data-tooltip="tooltip" data-placement="top" title="Clicking on Links will show the History of that Page in Date Order.">Page</th>
                <th class="" data-tooltip="tooltip" data-placement="top" title="Clicking on Origin Links will open that URL in a new window.">Origin</th>
                <th class="text-center" data-tooltip="tooltip" data-placement="top" title="Clicking on IP Links will Do a WhoIs on that IP in a new window.">IP</th>
