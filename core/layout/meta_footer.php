...
$().ready(function(){
  ...
  $window.resize(function(){
      ...
      if($elfinder.height()!=win_height){
          $elfinder.height(win_height-100).resize();
      }
  });
});
<?php }?>
...
/*        $('.media-edit').popover({
        ...
        $('.pathviewer').popover({
          ...
          container:'body',
          placement:'auto',
          template:'<div class="popover pathviewer" role="tooltip"><h3 class="popover-header"></h3><div class="popover-body"></div></div>',
          content:function(){
            var id=$(this).data("dbid");
            return $.ajax({
        ...
        $('.phpviewer').popover({
          ...
          container:'body',
          placement:'auto',
          template:'<div class="popover suggestions" role="tooltip"><h3 class="popover-header"></h3><div class="popover-body"></div></div>',
          content:function(){
            var id=$(this).data("dbid"),
                t=$(this).data("dbt");
            return $.ajax({
...
<?php if($user['rank']>899){?>
        $('.fingerprint').popover({
          ...
          container:'body',
          placement:'auto',
          template:'<div class="popover fingerprint" role="tooltip"><h3 class="popover-header"></h3><div class="popover-body"></div></div>',
          content:function(){
            var el=$(this).data("dbgid");
            var id=$('#'+el).data("dbid"),
                t=$('#'+el).data("dbt"),
