 ...
 *
 * pref_contact.php version 2.0.0
 *
...
<?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="business" data-tooltip="tooltip" title="Fingerprint Analysis">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
        ...
        <div class="form-group row">
          ...
          <div class="input-group col-sm-10">
<?php echo$user['rank']>899?'<div class="input-group-prepend"><button class="btn btn-secondary fingerprint" data-dbgid="abn" data-tooltip="tooltip" title="Fingerprint Analysis">'.svg2('libre-gui-fingerprint').'</button></div>':'';?>
            ...
            <div class="input-group-append" data-tooltip="tooltip" title="Save"><button id="saveabn" class="btn btn-secondary save" data-dbid="abn" data-style="zoom-in"><?php svg('libre-gui-save');?></button></div>
          </div>
        </div>
