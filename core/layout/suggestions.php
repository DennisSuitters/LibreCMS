...
<table class="table table-condensed table-striped table-hover" role="table">
  <thead>
    <tr role="row">
      ...
      <th class="text-right" role="columnnheader"></th>
    </tr>
  </thead>
  <tbody id="l_activity">
