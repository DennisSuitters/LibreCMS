...
$s=$db->prepare("SELECT * FROM suggestions WHERE rid=:id AND t=:t AND c=:c ORDER BY ti DESC");
$s->execute(
  array(
    ':id' => $id,
    ':t'  => $t,
